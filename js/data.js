...
const CV = {
  ui: {
    pt: {
      subtitle: "OutSystems Developer & DevOps/PlatOps",
      about:
        "Developer de OutSystems e DevOps/PlatOps, licenciado em Gestão da Distribuição e Logística e com um mestrado em Ciência de Dados para Empresas. Em 2019 mudei de carreira para a tecnologia — esta é a viagem.",
    ...
    en: {
      subtitle: "OutSystems Developer & DevOps/PlatOps",
      about:
        "OutSystems Developer & DevOps/PlatOps with a BSc in Distribution & Logistics Management and a Master's degree in Data Science for Business. In 2019 I switched careers into tech — this is the journey.",
    ...
    es: {
      subtitle: "OutSystems Developer & DevOps/PlatOps",
      about:
        "Developer de OutSystems y DevOps/PlatOps, graduado en Gestión de la Distribución y Logística y con un máster en Ciencia de Datos para Empresas. En 2019 cambié de carrera hacia la tecnología — este es el viaje.",
  ...
  stops: [
    ...
    },
    {
      ...
      bullets: {
        ...
        es: [
          ...
          "Desarrollo de servicios de IA-LLM (Modelos de Lenguaje de Gran Escala).",
    ...
    },
    {
      ...
      bullets: {
        pt: [
          "Licenciatura em Gestão da Distribuição e Logística — IPS/ESCE.",
          "Mestrado em Ciência de Dados para Empresas — IPS/ESCE.",
          ".NET Developer — IPS/ESCE + Upskill.",
        ],
        en: [
          "BSc in Distribution & Logistics Management — IPS/ESCE.",
          "Master's degree in Data Science for Business — IPS/ESCE.",
          ".NET Developer — IPS/ESCE + Upskill.",
        ],
        es: [
          "Grado en Gestión de la Distribución y Logística — IPS/ESCE.",
          "Máster en Ciencia de Datos para Empresas — IPS/ESCE.",
          ".NET Developer — IPS/ESCE + Upskill.",
        ],
      },
    },
